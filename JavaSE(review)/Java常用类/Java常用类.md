...
<img src="Java常用类.assets/image-20211205105806974.png" alt="image-20211205105806974" style="zoom:80%;" />
...
<img src="Java常用类.assets/image-20211205105929622.png" alt="image-20211205105929622" style="zoom:80%;" />
<img src="Java常用类.assets/image-20211205110004912.png" alt="image-20211205110004912" style="zoom:80%;" />
...
<img src="Java常用类.assets/image-20211205110026004.png" alt="image-20211205110026004" style="zoom:80%;" />
...
<img src="Java常用类.assets/image-20211205110131814.png" alt="image-20211205110131814" style="zoom:80%;" />

<img src="Java常用类.assets/image-20211205110156889.png" alt="image-20211205110156889" style="zoom:80%;" />
...
<img src="Java常用类.assets/image-20211205110259229.png" alt="image-20211205110259229" style="zoom:80%;" />
...
**说明：**首先，在方法的值传递时，引用数据类型传的是地址值，基本数据类型传的是存储的数据，在上述问题当中，change()中的str指向的是和上面属性的str指向的一样，都是字符串常量池中的"good"，但是change()方法中的str变成了"test ok"，那么常量池中会新建一个字符串"test ok"被change()方法中的str所指向，由于字符串的不可变性，上面属性的str仍然指向的是常量池中的"good"

## 1.6、JVM中涉及字符串的内存结构

<img src="Java常用类.assets/image-20211105172224236.png" alt="image-20211105172224236" style="zoom:80%;" />

<img src="Java常用类.assets/image-20211105172245605.png" alt="image-20211105172245605" style="zoom:80%;" />

<img src="Java常用类.assets/image-20211105172315049.png" alt="image-20211105172315049" style="zoom:80%;" />
...
<img src="Java常用类.assets/image-20211105225321410.png" alt="image-20211105225321410" style="zoom:80%;" />
...
<img src="Java常用类.assets/20171220135015076.png" alt="img" style="zoom:80%;" />
...
Java 8 吸收了Joda-Time 的精华，以一个新的开始为Java 创建优秀的API。新的`java.time` 中包含了所有关于**本地日期（LocalDate）**、**本地时间（LocalTime）**、**本地日期时间（LocalDateTime）**、**时区（ZonedDateTime）**和**持续时间（Duration）**的类。历史悠久的Date 类新增了`toInstant()`方法，用于把Date 转换成新的表示形式。这些新增的本地化时间日期API 大大简化了日期时间和本地化的管理。
...
public class JDK8DateTimeTest {
    ...
    public void test1(){
        ...
        System.out.println(localTime);//15:13:31.650
        System.out.println(localDateTime);//2019-02-18T15:13:31.650
...
<img src="Java常用类.assets/914ba4708727b970905de339e5817e25.png" alt="img" style="zoom: 67%;" />
...
<img src="Java常用类.assets/ec6afaca3ba677f17ecb872ea9ce28f3.png" alt="img" style="zoom: 67%;" />

> 时间戳是指格林威治时间1970年01月01日00时00分00秒(北京时间1970年01月01日08时00分00秒)起至现在的总秒数。

<img src="Java常用类.assets/64f3a70472a5112da67f2ab693576115.png" alt="img" style="zoom: 80%;" />
...
<img src="Java常用类.assets/da69c33ec0d15ba85fcb6768d62d2686.png" alt="img" style="zoom:67%;" />
...
<img src="Java常用类.assets/316c319a548bac159483c82432690094.png" alt="img" style="zoom:80%;" />
...
<img src="Java常用类.assets/a487be6770c3eacff3bc0bb872ab1d27.png" alt="img" style="zoom: 80%;" />
...
<img src="Java常用类.assets/a1b9e65f934b5efe345447284641b6b5.png" alt="img" style="zoom: 67%;" />
