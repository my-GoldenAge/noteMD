...
<img src="Java8新特性.assets/873337fa3d817235541f830b76bfc87e.png" alt="img" style="zoom:80%;" />
 ...
 * 
 * 4. Lambda表达式的本质: 作为接口的实例，而且接口必须是函数式接口（接口只有一个方法，下面讲）
 */
public class LambdaTest1 {
...
<img src="Java8新特性.assets/c4f4c62e55b8182fa7c99cd15a0d7de0.png" alt="img" style="zoom:80%;" />
...
| `forEach(Consumer c)`    | 内部迭代(使用Collection 接口需要用户去做迭代，称为外部迭代。<br />相反，Stream API 使用内部迭代它帮你把迭代做了) |
...
<img src="Java8新特性.assets/bd29b1fd138291421630d2d542675cf7.png" alt="img" style="zoom:80%;" />

<img src="Java8新特性.assets/0d4c3b7ce571549e8940d8c9e8192df1.png" alt="img" style="zoom:80%;" />
