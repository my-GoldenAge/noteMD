...
<img src="数据结构.assets/数据结构与算法.png" alt="数据结构与算法" style="zoom: 67%;" />
...
<img src="数据结构.assets/image-20211206183422497.png" alt="image-20211206183422497" style="zoom:80%;" />
...
<img src="数据结构.assets/栈应用.png" alt="栈应用" style="zoom:80%;" />
...
<img src="数据结构.assets/image-20211207173808656.png" alt="image-20211207173808656" style="zoom:80%;" />
...
<img src="数据结构.assets/image-20211207174025645.png" alt="image-20211207174025645" style="zoom:80%;" />
...
<img src="数据结构.assets/image-20211207200338742.png" alt="image-20211207200338742" style="zoom:80%;" />
...
<img src="数据结构.assets/image-20211207200700585.png" alt="image-20211207200700585" style="zoom:80%;" />
...
<img src="数据结构.assets/image-20211207203902603.png" alt="image-20211207203902603" style="zoom:80%;" />
...
<img src="数据结构.assets/image-20211207205733445.png" alt="image-20211207205733445" style="zoom:80%;" />
...
1. 它是完全二叉树，除了树的最后一层结点不需要是满的，其它的每一层从左到右都是满的，如果最后一层结点不是满的，那么要求左满右不满。
   ...
   <img src="数据结构.assets/image-20211208163711154.png" alt="image-20211208163711154" style="zoom:80%;" />

2. 它通常用数组来实现。

   具体方法就是将二叉树的结点按照层级顺序放入数组中，根结点在位置1，它的子结点在位置2和3，而子结点的子结点则分别在位置4,5,6和7，以此类推。

    <img src="数据结构.assets/image-20211208163855889.png" alt="image-20211208163855889" style="zoom:80%;" />
...
<img src="数据结构.assets/image-20211208164840385.png" alt="image-20211208164840385" style="zoom:80%;" />

<img src="数据结构.assets/image-20211208164910378.png" alt="image-20211208164910378" style="zoom:80%;" />

<img src="数据结构.assets/image-20211208165036040.png" alt="image-20211208165036040" style="zoom:80%;" />

<img src="数据结构.assets/image-20211208165115240.png" alt="image-20211208165115240" style="zoom:80%;" />

<img src="数据结构.assets/image-20211208165139593.png" alt="image-20211208165139593" style="zoom:80%;" />
...
<img src="数据结构.assets/image-20211208170217006.png" alt="image-20211208170217006" style="zoom:80%;" />

<img src="数据结构.assets/image-20211208170239076.png" alt="image-20211208170239076" style="zoom:80%;" />

<img src="数据结构.assets/image-20211208170345777.png" alt="image-20211208170345777" style="zoom:80%;" />

<img src="数据结构.assets/image-20211208170734087.png" alt="image-20211208170734087" style="zoom:80%;" />

<img src="数据结构.assets/image-20211208170826026.png" alt="image-20211208170826026" style="zoom:80%;" />
...
<img src="数据结构.assets/image-20211208193554850.png" alt="image-20211208193554850" style="zoom:80%;" />

<img src="数据结构.assets/image-20211208193802035.png" alt="image-20211208193802035" style="zoom:80%;" />

<img src="数据结构.assets/image-20211208193849739.png" alt="image-20211208193849739" style="zoom:80%;" />
...
<img src="数据结构.assets/image-20211208194125820.png" alt="image-20211208194125820" style="zoom:80%;" />

<img src="数据结构.assets/image-20211208194145483.png" alt="image-20211208194145483" style="zoom:80%;" />

<img src="数据结构.assets/image-20211208194216619.png" alt="image-20211208194216619" style="zoom:80%;" />

<img src="数据结构.assets/image-20211208194232644.png" alt="image-20211208194232644" style="zoom:80%;" />

<img src="数据结构.assets/image-20211208194256768.png" alt="image-20211208194256768" style="zoom:80%;" />

<img src="数据结构.assets/image-20211208194320733.png" alt="image-20211208194320733" style="zoom:80%;" />

<img src="数据结构.assets/image-20211208194339338.png" alt="image-20211208194339338" style="zoom:80%;" />
